...
public class pdpService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_PDP_DECISION))
            return this.decisionMessenger.getBinder();
        else if (intent.getAction().equals(ACTION_PDP_SETPOLICY))
            return this.setPolicyMessenger.getBinder();
        else if (intent.getAction().equals(ACTION_PDP_REVPOLICY))
            return this.revokePolicyMessenger.getBinder();
