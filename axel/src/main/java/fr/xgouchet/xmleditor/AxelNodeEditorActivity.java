...
public class AxelNodeEditorActivity extends Activity {
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		if (i == R.id.action_attr_custom) {
			addAttribute();

		} else if (i == R.id.action_attr_namespace) {
			addNamespaceAttribute(false);

		} else if (i == R.id.action_attr_default_namespace) {
			addNamespaceAttribute(true);

		} else if (i == R.id.action_attr_xml_schema_public) {
			addPublicSchema();

		} else if (i == R.id.action_attr_xml_schema_local) {
			addLocalSchema();

		} else if (i == R.id.action_doctype_xhtml_strict) {
			mEditText.setText(DTD_XHTML_STRICT_1_0);

		} else if (i == R.id.action_doctype_xhtml_transitional) {
			mEditText.setText(DTD_XHTML_TRANSITIONAL_1_0);

		} else if (i == R.id.action_doctype_xhtml_frameset) {
			mEditText.setText(DTD_XHTML_FRAMESET_1_0);

		} else if (i == R.id.action_doctype_xhtml_1_1) {
			mEditText.setText(DTD_XHTML_1_1);

		} else if (i == R.id.action_xsl_link) {
