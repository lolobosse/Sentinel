...
public class AxelActivity extends Activity implements
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		if (i == R.id.action_new_empty) {
			newContent();

		} else if (i == R.id.action_open_file) {
			openFile();

		} else if (i == R.id.action_open_recent) {
			openRecentFile();

		} else if (i == R.id.action_new_template) {// openTemplateFile();
			// Now we use fast access

		} else if (i == R.id.action_preview_in_browser) {
			previewFile();

		} else if (i == R.id.action_save) {
			saveContent();

		} else if (i == R.id.action_save_as) {
			saveContentAs();

		} else if (i == R.id.action_save_as_template) {
			promptTemplateName();
	...
	public void onItemClick(final Object source, final int pos,
		...
		} else if (actionId == R.id.action_add_child) {
			promptNodeAddChild();

		} else if (actionId == R.id.action_add_attr) {
			promptElementAddAttribute();

		} else if (actionId == R.id.action_edit) {
			doEditNode();

		} else if (actionId == R.id.action_sort_children) {
			doSortChildren();

		} else if (actionId == R.id.action_comment) {
			mEditor.doCommentUncommentNode();

		} else if (actionId == R.id.action_cut) {
			mEditor.doCutNode();

		} else if (actionId == R.id.action_copy) {
			mEditor.doCopyNode();

		} else if (actionId == R.id.action_paste) {
	...
	private final Callback mActionModeCallback = new Callback() {
		...
		public boolean onActionItemClicked(final ActionMode mode,
			...
			} else if (i == R.id.action_add_child) {
				promptNodeAddChild();

			} else if (i == R.id.action_add_attr) {
				promptElementAddAttribute();

			} else if (i == R.id.action_edit) {
				doEditNode();

			} else if (i == R.id.action_sort_children) {
				doSortChildren();

			} else if (i == R.id.action_comment) {
				mEditor.doCommentUncommentNode();

			} else if (i == R.id.action_cut) {
				mEditor.doCutNode();
